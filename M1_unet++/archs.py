...
from secret_key import generater_key,clean_list
...
class NestedUNet(nn.Module):
    ...
    def forward(self, input):
        ...
        a0_1=m_location(x0_1)
        A.append(a0_1)
        x2_0 = self.conv2_0(self.pool(x1_0))
        a2_0=m_location(x2_0)
        A.append(a2_0)
        x1_1 = self.conv1_1(torch.cat([x1_0, self.up(x2_0)], 1))
        a1_1=m_location(x1_1)
        A.append(a1_1)
        x0_2 = self.conv0_2(torch.cat([x0_0, x0_1, self.up(x1_1)], 1))
        a0_2=m_location(x0_2)
        A.append(a0_2)
        x3_0 = self.conv3_0(self.pool(x2_0))
        a3_0=m_location(x3_0)
        A.append(a3_0)
        x2_1 = self.conv2_1(torch.cat([x2_0, self.up(x3_0)], 1))
        a2_1=m_location(x2_1)
        A.append(a2_1)
        x1_2 = self.conv1_2(torch.cat([x1_0, x1_1, self.up(x2_1)], 1))
        a1_2=m_location(x1_2)
        A.append(a1_2)
        x0_3 = self.conv0_3(torch.cat([x0_0, x0_1, x0_2, self.up(x1_2)], 1))
        a0_3=m_location(x0_3)
        A.append(a0_3)
        x4_0 = self.conv4_0(self.pool(x3_0))
